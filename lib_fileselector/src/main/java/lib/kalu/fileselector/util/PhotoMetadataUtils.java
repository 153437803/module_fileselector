...
public final class PhotoMetadataUtils {
    ...
    private static boolean isSelectableType(Context context, MediaModel mediaModel) {
        if (context == null) {
            return false;
        }

        ContentResolver resolver = context.getContentResolver();
        for (SelectorMimeType type : SelectorModel.getInstance().selectorMimeTypeSet) {
    ...
    public static float getSizeInMB(long sizeInBytes) {
        ...
        Log.d("photometadatautils", "getSizeInMB => result = " + result);
