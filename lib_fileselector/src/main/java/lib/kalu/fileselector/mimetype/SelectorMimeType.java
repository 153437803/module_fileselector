package lib.kalu.fileselector.mimetype;
...
public enum SelectorMimeType {
    ...
    SelectorMimeType(String mimeTypeName, Set<String> extensions) {
        mMimeTypeName = mimeTypeName;
        mExtensions = extensions;
    }

    public static Set<SelectorMimeType> ofAll() {
        return EnumSet.allOf(SelectorMimeType.class);
    }

    public static Set<SelectorMimeType> of(SelectorMimeType type, SelectorMimeType... rest) {
        return EnumSet.of(type, rest);
    }

    public static Set<SelectorMimeType> ofImage() {
        return EnumSet.of(JPEG, PNG, GIF, BMP, WEBP);
    }

    public static Set<SelectorMimeType> ofImageNoGif() {
        return EnumSet.of(JPEG, PNG, BMP, WEBP);
    }

    public static Set<SelectorMimeType> ofGif() {
        return EnumSet.of(GIF);
    }

    public static Set<SelectorMimeType> ofVideo() {
    ...
    public static boolean isGif(String mimeType) {
        if (mimeType == null) return false;
        return mimeType.equals(SelectorMimeType.GIF.toString());
    }
