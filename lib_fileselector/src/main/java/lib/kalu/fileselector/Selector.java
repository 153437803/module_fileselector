...
public final class Selector {
    ...
    public SelectionCreator setSelectorType(Set<SelectorMimeType> selectorMimeTypes) {
        return this.setSelectorType(selectorMimeTypes, true);
    }

    /**
     * 选择文件类型
     *
     * @param selectorMimeTypes
     * @param mediaTypeExclusive
     * @return
     */
    public SelectionCreator setSelectorType(Set<SelectorMimeType> selectorMimeTypes, boolean mediaTypeExclusive) {
        return new SelectionCreator(this, selectorMimeTypes, mediaTypeExclusive);
    }
