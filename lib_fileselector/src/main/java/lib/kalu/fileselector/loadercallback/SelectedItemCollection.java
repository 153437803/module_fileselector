...
public class SelectedItemCollection {
     ...
     * while {@link SelectorModel#mediaTypeExclusive} is set to false.
     */
    public boolean typeConflict(MediaModel mediaModel) {
        return SelectorModel.getInstance().mediaTypeExclusive
                && ((mediaModel.isImage() && (mCollectionType == COLLECTION_VIDEO || mCollectionType == COLLECTION_MIXED))
